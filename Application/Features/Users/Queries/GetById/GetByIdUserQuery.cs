...
public class GetByIdUserQuery : IRequest<GetByIdUserResponse>, ISecuredRequest, ILoggableRequest
{
    public long Id { get; set; }

    public string[] Roles => [OperationClaims.GeneralAdmin, UserOperationClaims.View];
